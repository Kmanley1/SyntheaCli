...
| Duplicate ignore rules | `*.log` duplicates around lines 52 and 147 in `.gitignore`【F:.gitignore†L52-L58】【F:.gitignore†L145-L153】; `*.vspscc` also appears twice【F:.gitignore†L52-L56】【F:.gitignore†L200-L201】 | Consolidate each pattern once | Simplifies maintenance |
